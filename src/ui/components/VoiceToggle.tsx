/**
 * Voice Toggle Component - Enable/Disable Voice Output
 */
...
export const VoiceToggle: React.FC<VoiceToggleProps> = ({ isEnabled, onToggle }) => {
  return (
    <button
      onClick={onToggle}
      className={`neuro-button px-2 py-2 sm:px-3 transition-all ${isEnabled ? 'glow' : ''}`}
